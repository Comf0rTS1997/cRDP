...
cRDP is licensed under the **GNU General Public License v3.0** — see
[../LICENSE](../LICENSE) for the full text. All bundled third-party components
ship under GPLv3-compatible licenses (Apache 2.0, MIT); see
[../THIRD_PARTY.md](../THIRD_PARTY.md) for per-component details.
